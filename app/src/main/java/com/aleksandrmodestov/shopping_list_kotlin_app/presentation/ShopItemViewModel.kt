...
import com.aleksandrmodestov.shopping_list_kotlin_app.domain.AddShopItemUseCase
import com.aleksandrmodestov.shopping_list_kotlin_app.domain.EditShopItemUseCase
import com.aleksandrmodestov.shopping_list_kotlin_app.domain.GetShopItemUseCase
...
class ShopItemViewModel : ViewModel() {
    ...
    fun addShopItem(inputName: String?, inputCount: String?) {
        ...
        val isDataValid = validateInput(name, count)
        if (isDataValid) {
